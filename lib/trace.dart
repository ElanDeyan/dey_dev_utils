...
///
/// The function returns the same value as [block], making it a zero-cost abstraction
/// when called in optimized builds. Exceptions thrown by [block] are rethrown after
/// logging, preserving the original stack trace.
///
/// **Logging Output:**
/// - Start: `▶ <label> started`
...
///
/// Logs are written using [developer.log], which respects Dart's logging configuration
/// and appears in the DevTools timeline and logs.
///
...
/// ```dart
/// // Simple operation
/// final data = traced('fetch_users', () {
///   return fetchUsers();
/// });
///
/// // With complex logic
/// final result = traced('calculate', () {
///   var sum = 0;
...
/// // Error handling
/// try {
///   traced('risky_operation', () => riskyFunction());
/// } catch (e) {
...
/// - For async operations, consider using similar tracing manually with `Future`.
